...
Prepares the renewal conversation itself: what you concede, what you will not, the walk-away, and the four asks you are going to get. Built on the rule that every concession is permanent unless you deliberately make it temporary.
...
> Download the `renewal-negotiation` skill from https://github.com/CSPulse/customer-success-skills/tree/main/skills/renewal-negotiation, zip the `renewal-negotiation` folder on its own, then upload it as a skill in Claude.
