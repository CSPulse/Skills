...
Maps who decides an account's outcome by what they can do to it rather than by job title. Flags who has never actually been met, tests for single-threading, and tracks who went quiet.
...
```
Download the stakeholder-map skill from https://github.com/CSPulse/customer-success-skills/tree/main/skills/stakeholder-map, zip the stakeholder-map folder on its own, then upload it as a skill in Claude.
```
