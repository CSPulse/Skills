...
Produces a defensible read on whether an account will renew: the decision, the decider, the mechanism, the dollars and the play. Built on the principle that usage describes the user while the renewal is decided by the buyer.
...
```
Download the renewal-risk skill from https://github.com/CSPulse/customer-success-skills/tree/main/skills/renewal-risk, zip the renewal-risk folder on its own, then upload it as a skill in Claude.
```
