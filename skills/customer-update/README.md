...
Writes the proactive message nobody wants to send: an incident, a delay, a deprecation, a price change, a change of CSM. Segments by impact rather than by mailing list, and says plainly whether action is needed.
...
```
Download the customer-update skill from https://github.com/CSPulse/customer-success-skills/tree/main/skills/customer-update, zip the customer-update folder on its own, then upload it as a skill in Claude.
```
