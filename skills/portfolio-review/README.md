...
Reviews your team's reads rather than their accounts. Samples rather than covers, always includes a random five, and asks the four questions that expose a read with no mechanism behind it.
...
```
Download the portfolio-review skill from https://github.com/CSPulse/customer-success-skills/tree/main/skills/portfolio-review, zip the portfolio-review folder on its own, then upload it as a skill in Claude.
```
